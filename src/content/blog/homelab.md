...
In 2024, the hinge on my Dell XPS 15 crushed its screen. Replacing the 4K touchscreen and hinges cost too much, but the rest of the laptop still worked well. It sat there, half-useless, until a YouTube video offered the obvious answer: turn it into a server.
...
The build has not been smooth. I have dealt with power cuts, a failing SMART disk, and internal IP reshuffles. Hardware acceleration is also unavailable because `nvidia-smi` does not cooperate with this setup. Each problem has taught me more than the parts that worked first time.

What began as a broken laptop became a learning sandbox. It has enough real responsibility to make mistakes valuable without putting a business at risk. The build story starts here. [Why I keep self-hosting](/blog/self-hosting) explains what that control costs and why I still enjoy it.
