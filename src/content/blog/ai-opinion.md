...
I am a vibe coder. There, I said it.

I have spent months testing models, prompt styles, and combinations of tools. For my work, Opus is often useful for polish and UI. GPT is good at pushing through features and bugs. Different jobs need different tools. You do not use a sledgehammer for everything.

## The division of labour

AI-assisted coding works well for me, but not because I can stop paying attention. When a task goes wrong, it is often a steering or context problem. The agent might edit a local SQLite database instead of production. It might also miss a feature that was never properly integrated. I still need to understand the system, choose the direction, and check the result.

I write games, apps, terminal tools, Rust backends, C++, GraphQL, and database code. I am also learning AWS. That wider understanding matters. AI can make the work faster, but it cannot make a confused design coherent through sheer enthusiasm.

The metaphor I keep returning to is simple. I own the architecture and judgement. AI helps with the building.

## What it does not replace

The graduate job market has been rough from where I am standing. I applied for plenty of student internships and did not get a response or interview. That result is difficult to reconcile with the work I have put into learning. It also reminds me that technical knowledge alone does not guarantee an opportunity.
...
This is where I worry. With a Canvas API key and an MCP server, an agent can retrieve an assignment and its related files. It can then produce an answer and potentially submit it in minutes. If a student delegates that whole loop, no learning takes place.
...
Today's models are capable pattern engines, not colleagues who can own the consequences of a bad decision. Privacy, trust, incomplete context, and human approval limit how much autonomy I will give them.
