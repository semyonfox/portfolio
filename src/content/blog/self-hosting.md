...
Privacy became part of the motivation as I learnt more. Keeping a service at home does not make it private by default. However, it gives me more control over access, retention, and software.

## The bill still arrives

Self-hosting is not automatically cheaper than paying for cloud services. Hardware, electricity, replacement drives, and my own time all count. A hosted service also removes much of the maintenance. It is often the sensible choice when convenience matters more than control.
...
Scaling is not free either. A larger disk or another enclosure creates more capacity. It can also create more data to protect and more hardware to maintain. That trade-off is easy to ignore when buying drives is the fun part.

## Learning by operating

The hands-on work is still the main attraction for me. It includes jobs, clean-ups, maintenance schedules, monitoring, alerts, dashboards, and the occasional late-night mystery. It is an endless rabbit hole, and I genuinely enjoy it.
...
That experience has taught me Linux, networking, containers, administration, and monitoring in a way that complements university work. It also made me more aware of the parts beyond application code. These include storage, deployment, observability, recovery, and the people who depend on the service.

I no longer think the goal is to self-host everything. I keep services when their control or learning value justifies the upkeep. I use hosted tools when they offer the better trade. The point is to understand enough to choose deliberately.
